...
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub struct ShiftType(pub u64);
impl ShiftType {
    pub fn shamt(&self) -> u64 {
        (self.0 >> 20) & 0x3f
    }
    pub fn rs1(&self) -> u64 {
        (self.0 >> 15) & 0x1f
